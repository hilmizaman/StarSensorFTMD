...
for iii in range(100):
    ...
    ra0 = random.randint(-180,180)
    de0 = random.randint(-90,90)
    roll0 = random.randint(-180,180)
    ...
    cv2.imwrite("./star_simulator-main/sample_images/Tes_Random_new/"+str(iii+1)+"_"+file_name,background)
...
with open('RA_dec_roll2.csv', 'w', newline='') as csvfile:
