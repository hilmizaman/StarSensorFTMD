...
int main() {
  ...
  // CREATE NECESSARY ARRAYS FOR ITERATIONS
    ...
    imgPath = "/home/hilmi/star-sensor-ftmd/StarSensorFTMD_hilmi/StarSensorFTMD/main/picture.jpg";
    imgPathArray = imgPath;

    // ARRAYS OF RESULT PATHS
    resultPath = "/home/hilmi/star-sensor-ftmd/StarSensorFTMD_hilmi/StarSensorFTMD/main/cent.csv";
  ...
  for (int bigIndex = 0; bigIndex < imgNumber; bigIndex++) {
    ...
    // 1. BASIC DECLARATION AND DEFINITION
        ...
        cv::Mat img = cv::imread(imgPathArray);      // Loading a Star Image
